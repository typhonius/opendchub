...
void create_banlist(void) { /* Removed — gateway owns data */ }

/* Creates gaglist if it does not exist */
void create_gaglist(void) { /* Removed */ }

/* Creates nickbanlist if it does not exist */
void create_nickbanlist(void) { /* Removed */ }

/* Creates allowlist if it does not exist */
void create_allowlist(void) { /* Removed */ }

/* Creates reglist if it does not exist */
void create_reglist(void) { /* Removed */ }

/* Creates op_permlist if it does not exist */
void create_op_permlist(void) { /* Removed */ }
